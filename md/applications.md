...
<s-column style="--gap: 1.5rem;">
  ...
  <s-row>
    <a class="floating-link-panel" href="https://instruxmusic.com">
      <img src="https://instruxmusic.com/images/stacked-logo.svg?v=832b2dd2" class="link-icon" style="height: 48px; width: auto;">Instrux Music
    </a>
  </s-row>
  <s-row>
